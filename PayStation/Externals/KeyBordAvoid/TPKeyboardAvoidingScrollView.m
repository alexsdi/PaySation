...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    ...
    if([self.dele respondsToSelector:@selector(textField:shouldChangeCharactersInRange:replacementString:)]) {
        
      return  [self.dele textField:textField shouldChangeCharactersInRange:range replacementString:string];
